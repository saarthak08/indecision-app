    ...
    _createClass(IndecisionApp, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(AddOptions, { addOption: this.handleAddOption })
            );
        }
    }]);
...
var AddOptions = function (_React$Component2) {
    ...
    function AddOptions(props) {
        ...
        _this2.onFormSubmitted = _this2.onFormSubmitted.bind(_this2);
        _this2.state = {
            error: undefined
        };
        return _this2;
    ...
    _createClass(AddOptions, [{
        key: 'onFormSubmitted',
        value: function onFormSubmitted(e) {
            e.preventDefault();
            var option = e.target.elements.inputText.value.trim();
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('input', { type: 'text', name: 'inputText', placeholder: 'Your text here!' }),
                    '\u2003',
                    React.createElement(
                        'button',
                        null,
